...
public interface ElixirTypes {
  ...
  IElementType STAB_OPERATIONS = new ElixirElementType("STAB_OPERATIONS");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == EEX_STAB_BODY) {
        return new ElixirEexStabBodyImpl(node);
      }
      else if (type == EEX_STAB_OPERATION) {
        return new ElixirEexStabOperationImpl(node);
      }
      ...
      else if (type == STAB_OPERATIONS) {
        return new ElixirStabOperationsImpl(node);
      }
