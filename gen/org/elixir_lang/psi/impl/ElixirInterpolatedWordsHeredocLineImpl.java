...
public class ElixirInterpolatedWordsHeredocLineImpl extends ASTWrapperPsiElement implements ElixirInterpolatedWordsHeredocLine {
  ...
  public ElixirInterpolatedWordsHeredocLineImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ElixirInterpolatedWordsHeredocLineBody getInterpolatedWordsHeredocLineBody() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, ElixirInterpolatedWordsHeredocLineBody.class));
  }
