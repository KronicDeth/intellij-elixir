...
public class ElixirUnqualifiedNoParenthesesManyArgumentsCallImpl extends NamedStubbedPsiElementBase<UnqualifiedNoParenthesesManyArgumentsCall> implements ElixirUnqualifiedNoParenthesesManyArgumentsCall {
  ...
  public ElixirUnqualifiedNoParenthesesManyArgumentsCallImpl(@NotNull UnqualifiedNoParenthesesManyArgumentsCall stub, @NotNull IStubElementType type) {
    super(stub, type);
  }

  public ElixirUnqualifiedNoParenthesesManyArgumentsCallImpl(@NotNull ASTNode node) {
    super(node);
  }
