...
public class ElixirLiteralCharListSigilHeredocImpl extends ASTWrapperPsiElement implements ElixirLiteralCharListSigilHeredoc {

  public ElixirLiteralCharListSigilHeredocImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ElixirLiteralCharListHeredocLine> getLiteralCharListHeredocLineList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirLiteralCharListHeredocLine.class);
  }
