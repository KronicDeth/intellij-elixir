...
public class ElixirMatchedUnqualifiedNoArgumentsCallImpl extends NamedStubbedPsiElementBase<MatchedUnqualifiedNoArgumentsCall> implements ElixirMatchedUnqualifiedNoArgumentsCall {
  ...
  public ElixirMatchedUnqualifiedNoArgumentsCallImpl(@NotNull MatchedUnqualifiedNoArgumentsCall stub, @NotNull IStubElementType type) {
    super(stub, type);
  }

  public ElixirMatchedUnqualifiedNoArgumentsCallImpl(@NotNull ASTNode node) {
    super(node);
  }
