...
public class ElixirInterpolatedRegexHeredocLineImpl extends ASTWrapperPsiElement implements ElixirInterpolatedRegexHeredocLine {
  ...
  public ElixirInterpolatedRegexHeredocLineImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ElixirInterpolatedRegexHeredocLineBody getInterpolatedRegexHeredocLineBody() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, ElixirInterpolatedRegexHeredocLineBody.class));
  }
