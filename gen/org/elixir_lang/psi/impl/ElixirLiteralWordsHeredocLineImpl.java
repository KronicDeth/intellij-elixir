...
public class ElixirLiteralWordsHeredocLineImpl extends ASTWrapperPsiElement implements ElixirLiteralWordsHeredocLine {
  ...
  public ElixirLiteralWordsHeredocLineImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ElixirLiteralWordsHeredocLineBody getLiteralWordsHeredocLineBody() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, ElixirLiteralWordsHeredocLineBody.class));
  }
