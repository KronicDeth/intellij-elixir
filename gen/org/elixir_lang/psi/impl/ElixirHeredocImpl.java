...
public class ElixirHeredocImpl extends ASTWrapperPsiElement implements ElixirHeredoc {
  ...
  public ElixirHeredocImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ElixirHeredocLine> getHeredocLineList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirHeredocLine.class);
  }
