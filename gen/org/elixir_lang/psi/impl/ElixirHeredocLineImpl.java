...
public class ElixirHeredocLineImpl extends ASTWrapperPsiElement implements ElixirHeredocLine {

  public ElixirHeredocLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ElixirVisitor visitor) {
    visitor.visitHeredocLine(this);
  }
  ...
  @Override
  @NotNull
  public ElixirHeredocLineBody getHeredocLineBody() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, ElixirHeredocLineBody.class));
  }
