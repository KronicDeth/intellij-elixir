...
public class ElixirMatchedQualifiedNoParenthesesCallImpl extends NamedStubbedPsiElementBase<MatchedQualifiedNoParenthesesCall> implements ElixirMatchedQualifiedNoParenthesesCall {
  ...
  public ElixirMatchedQualifiedNoParenthesesCallImpl(@NotNull MatchedQualifiedNoParenthesesCall stub, @NotNull IStubElementType type) {
    super(stub, type);
  }

  public ElixirMatchedQualifiedNoParenthesesCallImpl(@NotNull ASTNode node) {
    super(node);
  }
