...
public class ElixirLiteralRegexLineImpl extends ElixirMatchedExpressionImpl implements ElixirLiteralRegexLine {

  public ElixirLiteralRegexLineImpl(ASTNode node) {
    super(node);
  }
