...
public class ElixirBracketAtExpressionImpl extends ASTWrapperPsiElement implements ElixirBracketAtExpression {

  public ElixirBracketAtExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ElixirVisitor) ((ElixirVisitor)visitor).visitBracketAtExpression(this);
  ...
  public ElixirAtOperatorEOL getAtOperatorEOL() {
    return findNotNullChildByClass(ElixirAtOperatorEOL.class);
  }
