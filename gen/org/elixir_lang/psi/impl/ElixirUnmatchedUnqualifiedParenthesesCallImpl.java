...
public class ElixirUnmatchedUnqualifiedParenthesesCallImpl extends NamedStubbedPsiElementBase<UnmatchedUnqualifiedParenthesesCall> implements ElixirUnmatchedUnqualifiedParenthesesCall {
  ...
  public ElixirUnmatchedUnqualifiedParenthesesCallImpl(@NotNull UnmatchedUnqualifiedParenthesesCall stub, @NotNull IStubElementType type) {
    super(stub, type);
  }

  public ElixirUnmatchedUnqualifiedParenthesesCallImpl(@NotNull ASTNode node) {
    super(node);
  }
