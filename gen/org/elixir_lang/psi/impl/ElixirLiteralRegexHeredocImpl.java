...
public class ElixirLiteralRegexHeredocImpl extends ASTWrapperPsiElement implements ElixirLiteralRegexHeredoc {

  public ElixirLiteralRegexHeredocImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ElixirLiteralRegexHeredocLine> getLiteralRegexHeredocLineList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirLiteralRegexHeredocLine.class);
  }
