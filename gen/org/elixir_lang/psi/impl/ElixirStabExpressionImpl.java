...
public class ElixirStabExpressionImpl extends ASTWrapperPsiElement implements ElixirStabExpression {

  public ElixirStabExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ElixirVisitor) ((ElixirVisitor)visitor).visitStabExpression(this);
  ...
  @Override
  @Nullable
  public ElixirStabOperation getStabOperation() {
    return findChildByClass(ElixirStabOperation.class);
  }
