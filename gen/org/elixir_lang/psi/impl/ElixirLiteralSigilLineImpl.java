...
public class ElixirLiteralSigilLineImpl extends ASTWrapperPsiElement implements ElixirLiteralSigilLine {

  public ElixirLiteralSigilLineImpl(@NotNull ASTNode node) {
    super(node);
  }
