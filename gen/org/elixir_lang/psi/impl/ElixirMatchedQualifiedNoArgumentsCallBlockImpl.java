...
public class ElixirMatchedQualifiedNoArgumentsCallBlockImpl extends ElixirMatchedExpressionImpl implements ElixirMatchedQualifiedNoArgumentsCallBlock {

  public ElixirMatchedQualifiedNoArgumentsCallBlockImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ElixirVisitor) ((ElixirVisitor)visitor).visitMatchedQualifiedNoArgumentsCallBlock(this);
