...
public class ElixirInterpolatedWordsHeredocImpl extends ASTWrapperPsiElement implements ElixirInterpolatedWordsHeredoc {

  public ElixirInterpolatedWordsHeredocImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ElixirInterpolatedWordsHeredocLine> getInterpolatedWordsHeredocLineList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirInterpolatedWordsHeredocLine.class);
  }
