...
public class ElixirInterpolatedRegexHeredocImpl extends ASTWrapperPsiElement implements ElixirInterpolatedRegexHeredoc {

  public ElixirInterpolatedRegexHeredocImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public List<ElixirInterpolatedRegexHeredocLine> getInterpolatedRegexHeredocLineList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirInterpolatedRegexHeredocLine.class);
  }
