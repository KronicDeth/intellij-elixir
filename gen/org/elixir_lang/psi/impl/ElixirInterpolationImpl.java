...
public class ElixirInterpolationImpl extends ASTWrapperPsiElement implements ElixirInterpolation {
  ...
  @Override
  @NotNull
  public List<ElixirMatchedAndOperation> getMatchedAndOperationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirMatchedAndOperation.class);
  }
  ...
  @Override
  @NotNull
  public List<ElixirMatchedComparisonOperation> getMatchedComparisonOperationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirMatchedComparisonOperation.class);
  }
  ...
  @Override
  @NotNull
  public List<ElixirMatchedInMatchOperation> getMatchedInMatchOperationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirMatchedInMatchOperation.class);
  }
  ...
  @Override
  @NotNull
  public List<ElixirMatchedMatchOperation> getMatchedMatchOperationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirMatchedMatchOperation.class);
  }
  ...
  @Override
  @NotNull
  public List<ElixirMatchedPipeOperation> getMatchedPipeOperationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirMatchedPipeOperation.class);
  }
  ...
  @Override
  @NotNull
  public List<ElixirMatchedWhenOperation> getMatchedWhenOperationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ElixirMatchedWhenOperation.class);
  }
