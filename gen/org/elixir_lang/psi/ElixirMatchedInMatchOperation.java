...
public interface ElixirMatchedInMatchOperation extends InfixOperation {
  ...
  @NotNull
  List<ElixirMatchedAndOperation> getMatchedAndOperationList();
  ...
  @NotNull
  List<ElixirMatchedComparisonOperation> getMatchedComparisonOperationList();
  ...
  @NotNull
  List<ElixirMatchedPipeOperation> getMatchedPipeOperationList();
