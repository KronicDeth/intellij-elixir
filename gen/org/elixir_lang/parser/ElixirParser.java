...
public class ElixirParser implements PsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    create_token_set_(ADDITION_OPERATION, ARROW_OPERATION, ATOM, EXPRESSION,
      HAT_OPERATION, MULTIPLICATION_OPERATION, RELATIONAL_OPERATION, TWO_OPERATION,
  ...
  // 0: BINARY(relationalOperation)
  // 1: BINARY(arrowOperation)
  // 2: BINARY(twoOperation)
  // 3: BINARY(additionOperation)
  // 4: BINARY(multiplicationOperation)
  // 5: BINARY(hatOperation)
  // 6: PREFIX(unaryOperation)
  // 7: ATOM(value)
