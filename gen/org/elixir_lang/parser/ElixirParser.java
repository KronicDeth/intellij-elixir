...
public class ElixirParser implements PsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    create_token_set_(ADDITION_OPERATION, ARROW_OPERATION, ATOM, EXPRESSION,
      HAT_OPERATION, MULTIPLICATION_OPERATION, TWO_OPERATION, UNARY_OPERATION,
      VALUE),
  };
  ...
  // 0: BINARY(arrowOperation)
  // 1: BINARY(twoOperation)
  // 2: BINARY(additionOperation)
  // 3: BINARY(multiplicationOperation)
  // 4: BINARY(hatOperation)
  // 5: PREFIX(unaryOperation)
  // 6: ATOM(value)
