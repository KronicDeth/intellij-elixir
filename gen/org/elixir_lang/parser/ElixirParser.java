...
public class ElixirParser implements PsiParser {
  ...
  // 0: BINARY(andOperation)
  // 1: BINARY(comparisonOperation)
  // 2: BINARY(relationalOperation)
  // 3: BINARY(arrowOperation)
  // 4: BINARY(twoOperation)
  // 5: BINARY(additionOperation)
  // 6: BINARY(multiplicationOperation)
  // 7: BINARY(hatOperation)
  // 8: PREFIX(unaryOperation)
  // 9: ATOM(value)
