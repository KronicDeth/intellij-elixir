...
public class ElixirParser implements PsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    create_token_set_(ADDITION_OPERATION, ARROW_OPERATION, ATOM, COMPARISON_OPERATION,
      EXPRESSION, HAT_OPERATION, MULTIPLICATION_OPERATION, RELATIONAL_OPERATION,
  ...
  // 0: BINARY(comparisonOperation)
  // 1: BINARY(relationalOperation)
  // 2: BINARY(arrowOperation)
  // 3: BINARY(twoOperation)
  // 4: BINARY(additionOperation)
  // 5: BINARY(multiplicationOperation)
  // 6: BINARY(hatOperation)
  // 7: PREFIX(unaryOperation)
  // 8: ATOM(value)
  ...
  public static boolean unaryOperation(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_;
    result_ = pinned_ && expression(builder_, level_, 7);
