...
public class ElixirParser implements PsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(AT_EXPRESSION_OPERATION, AT_EXPRESSION_PREFIX_OPERATION, AT_MATCHED_EXPRESSION_OPERATION, AT_MATCHED_EXPRESSION_PREFIX_OPERATION,
      ...
      UNARY_EXPRESSION_OPERATION, UNARY_EXPRESSION_PREFIX_OPERATION, UNARY_MATCHED_EXPRESSION_OPERATION, UNARY_MATCHED_EXPRESSION_PREFIX_OPERATION),
    create_token_set_(AT_EXPRESSION_OPERATION, AT_EXPRESSION_PREFIX_OPERATION, AT_MATCHED_EXPRESSION_OPERATION, AT_MATCHED_EXPRESSION_PREFIX_OPERATION,
      CAPTURE_EXPRESSION_OPERATION, CAPTURE_MATCHED_EXPRESSION_OPERATION, CAPTURE_MATCHED_EXPRESSION_PREFIX_OPERATION, MATCHED_EXPRESSION,
  ...
  public static boolean captureExpressionPrefixOperation(PsiBuilder b, int l) {
    ...
    r = nonNumericCapturePrefixOperator(b, l + 1);
    r = r && captureExpressionOperand(b, l + 1);
    r = r && captureExpressionPrefixOperation_2(b, l + 1);
    exit_section_(b, m, CAPTURE_EXPRESSION_PREFIX_OPERATION, r);
    return r;
  }

  // { captureExpressionOperation }
  private static boolean captureExpressionPrefixOperation_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "captureExpressionPrefixOperation_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = captureExpressionOperation(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
