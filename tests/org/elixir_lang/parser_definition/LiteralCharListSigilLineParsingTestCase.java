 ...
 */
public class LiteralCharListSigilLineParsingTestCase extends ParsingTestCase {
    ...
    protected String getTestDataPath() {
        return super.getTestDataPath() + "/literal_char_list_sigil_line_parsing_test_case";
    }
}
