 ...
 */
public class MatchedComparisonOperationParsingTestCase extends ParsingTestCase {
    ...
    protected String getTestDataPath() {
        return super.getTestDataPath() + "/matched_comparison_operation_parsing_test_case";
    }
}
