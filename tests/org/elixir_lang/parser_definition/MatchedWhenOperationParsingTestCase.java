 ...
 */
public class MatchedWhenOperationParsingTestCase extends ParsingTestCase {
    ...
    public void testNoParenthesesKeywords() {
        assertParsedAndQuotedCorrectly();
    }
    ...
    protected String getTestDataPath() {
        return super.getTestDataPath() + "/matched_when_operation_parsing_test_case";
    }
}
