...
public class WordsTest extends TokenTest {
        /*
     * Constructors
     */

    public WordsTest(CharSequence charSequence, IElementType tokenType, int lexicalState, boolean consumeAll) {
    ...
    public static Collection<Object[]> generateData() {
        return Arrays.asList(
                new Object[][]{
                        ...
                        {";", ElixirTypes.WORDS_FRAGMENT, ElixirFlexLexer.GROUP_HEREDOC_LINE_BODY, true },
