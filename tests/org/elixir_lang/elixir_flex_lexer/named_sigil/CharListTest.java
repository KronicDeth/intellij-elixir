...
public class CharListTest {
    ...
    private void reset(CharSequence charSequence) throws IOException {
        ...
        CharSequence fullCharSequence = "~c" + charSequence;
    ...
    public void tripleDoubleQuotes() throws IOException {
        ...
        assertEquals(ElixirTypes.CHAR_LIST_SIGIL_HEREDOC_PROMOTER, flexLexer.advance());
    ...
    public void openingBrace() throws IOException {
        ...
        assertEquals(ElixirTypes.CHAR_LIST_SIGIL_PROMOTER, flexLexer.advance());
