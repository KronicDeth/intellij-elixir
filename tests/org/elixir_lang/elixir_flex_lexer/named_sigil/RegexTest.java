...
public class RegexTest {
    ...
    private void reset(CharSequence charSequence) throws IOException {
        ...
        CharSequence fullCharSequence = "~r" + charSequence;
    ...
    public void tripleDoubleQuotes() throws IOException {
        ...
        assertEquals(ElixirTypes.REGEX_HEREDOC_PROMOTER, flexLexer.advance());
    ...
    public void openingBrace() throws IOException {
        ...
        assertEquals(ElixirTypes.REGEX_PROMOTER, flexLexer.advance());
