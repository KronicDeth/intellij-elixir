...
public class StringTest {
    ...
    private void reset(CharSequence charSequence) throws IOException {
        ...
        CharSequence fullCharSequence = "~s" + charSequence;
    ...
    public void tripleDoubleQuotes() throws IOException {
        ...
        assertEquals(ElixirTypes.STRING_SIGIL_HEREDOC_PROMOTER, flexLexer.advance());
    ...
    public void openingBrace() throws IOException {
        ...
        assertEquals(ElixirTypes.STRING_SIGIL_PROMOTER, flexLexer.advance());
