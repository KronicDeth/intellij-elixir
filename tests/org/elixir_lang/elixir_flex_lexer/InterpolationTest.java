...
public class InterpolationTest extends TokenTest {
    ...
    public static Collection<Object[]> generateData() {
        return Arrays.asList(new Object[][]{
                        ...
                        { "..", ElixirTypes.TWO_OPERATOR, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true},
                        { "...", ElixirTypes.IDENTIFIER, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true },
                        { "001234567", ElixirTypes.VALID_DECIMAL_DIGITS, ElixirFlexLexer.DECIMAL_INTEGER, true },
                        ...
                        { "0b10", ElixirTypes.BASE_INTEGER_PREFIX, ElixirFlexLexer.BASE_INTEGER_BASE, false },
                        { "0o01234567", ElixirTypes.BASE_INTEGER_PREFIX, ElixirFlexLexer.BASE_INTEGER_BASE, false },
                        { "0x0123456789abcdefABCDEF", ElixirTypes.BASE_INTEGER_PREFIX, ElixirFlexLexer.BASE_INTEGER_BASE, false },
                        { "1.", ElixirTypes.VALID_DECIMAL_DIGITS, ElixirFlexLexer.DECIMAL_INTEGER, false },
                        ...
                        { "1234567890", ElixirTypes.VALID_DECIMAL_DIGITS, ElixirFlexLexer.DECIMAL_INTEGER, true },
                        { "1_", ElixirTypes.VALID_DECIMAL_DIGITS, ElixirFlexLexer.DECIMAL_INTEGER, false},
                        { "1_2_3_4_5_6_7_8_9_0", ElixirTypes.VALID_DECIMAL_DIGITS, ElixirFlexLexer.DECIMAL_INTEGER, false },
                        ...
                        { "Enum", ElixirTypes.ALIAS, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true },
                        ...
                        { "\t", TokenType.WHITE_SPACE, INITIAL_STATE, true },
                        { "^", ElixirTypes.UNARY_OPERATOR, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true},
                        { "_identifier", ElixirTypes.IDENTIFIER, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true },
                        { "and", ElixirTypes.AND_OPERATOR, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true},
                        { "defmodule", ElixirTypes.IDENTIFIER, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true },
                        ...
                        { "identifier!", ElixirTypes.IDENTIFIER, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true },
                        { "identifier", ElixirTypes.IDENTIFIER, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true },
                        { "identifier9", ElixirTypes.IDENTIFIER, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true },
                        { "identifier?", ElixirTypes.IDENTIFIER, ElixirFlexLexer.KEYWORD_PAIR_MAYBE, true },
