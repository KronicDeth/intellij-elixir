...
public class YYInitialTest extends TokenTest {
    ...
    public static Collection<Object[]> generateData() {
        return Arrays.asList(new Object[][]{
                        ...
                        { "..", ElixirTypes.TWO_OPERATOR, INITIAL_STATE, true},
                        { "001234567", TokenType.BAD_CHARACTER, ElixirFlexLexer.YYINITIAL, false },
                        { "0B10", TokenType.BAD_CHARACTER, ElixirFlexLexer.YYINITIAL, false },
                        { "0X0123456789abcdefABCDEF", TokenType.BAD_CHARACTER, ElixirFlexLexer.YYINITIAL, false },
