...
public class WhiteSpaceBodyTest extends Test {
    private static final Lex[][] TAGS = new Lex[][]{
            ...
            {new Lex("<%", Types.OPENING, Flex.LONG_COMMENT_MARKER), new Lex("!--", Types.COMMENT_MARKER, Flex.LONG_COMMENT), new Lex(" ", Types.COMMENT, Flex.LONG_COMMENT), new Lex("--%>", Types.CLOSING, Flex.WHITESPACE_MAYBE)}
    };
