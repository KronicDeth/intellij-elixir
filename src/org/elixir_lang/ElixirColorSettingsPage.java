...
public class ElixirColorSettingsPage implements ColorSettingsPage {
    ...
    private static final AttributesDescriptor[] DESCRIPTORS = new AttributesDescriptor[]{
            ...
            new AttributesDescriptor("Declarations//Function", ElixirSyntaxHighlighter.FUNCTION_DECLARATION),
            new AttributesDescriptor("Declarations//Macro", ElixirSyntaxHighlighter.MACRO_DECLARATION),
            ...
            new AttributesDescriptor("Module Attributes//Type Specifications//Callback", ElixirSyntaxHighlighter.CALLBACK),
            new AttributesDescriptor("Module Attributes//Type Specifications//Specification", ElixirSyntaxHighlighter.SPECIFICATION),
            new AttributesDescriptor("Module Attributes//Type Specifications//Type", ElixirSyntaxHighlighter.TYPE),
            new AttributesDescriptor("Module Attributes//Type Specifications//Type Parameter", ElixirSyntaxHighlighter.TYPE_PARAMETER),
