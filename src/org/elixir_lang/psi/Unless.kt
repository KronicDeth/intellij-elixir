...
object Unless {
    ...
    fun treeWalkUp(unlessCall: Call,
        ...
        val foundInFalseBranch = treeWalkUpFalseBranch(unlessCall, resolveState, keepProcessing)
        val foundInTrueBranch = treeWalkUpTrueBranch(unlessCall, resolveState, keepProcessing)
