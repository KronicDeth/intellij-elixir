...
class ElementDescriptionProvider : com.intellij.psi.ElementDescriptionProvider {
    ...
    private fun getElementDescription(call: Call, location: ElementDescriptionLocation): String? =
            when {
                ...
                Implementation.`is`(call) -> Implementation.elementDescription(call, location)
                ...
                org.elixir_lang.structure_view.element.Quote.`is`(call) -> org.elixir_lang.structure_view.element.Quote.elementDescription(call, location)
