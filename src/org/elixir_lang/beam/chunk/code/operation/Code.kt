 ...
 */
enum class Code(val number: Int, val function: String, val arity: Int, val argumentNames: Array<String>? = null) {
    // @spec label Lbl
    // @doc Specify a module local label.
    //      Label gives this code address a name (Lbl) and marks the start of
    //      a basic block.
    LABEL(1, "label", 1, arrayOf("label")),

    // @spec func_info M F A
    // @doc Define a function M:F/A
    FUNC_INFO(2, "func_info", 3, arrayOf("module", "function", "arity")),
    ...
    CALL(4, "call", 2, arrayOf("arity", "label")),
    ...
    ALLOCATE(12, "allocate", 2, arrayOf("words_of_stack", "live_x_register_count")),
    ...
    //      Also save the continuation pointer (CP) on the stack.
    ALLOCATE_ZERO(14, "allocate_zero", 2, arrayOf("words_of_stack", "live_x_register_count")),
    ...
    SELECT_VAL(59, "select_val", 3, arrayOf("arity", "fail_label", "arity_label_list")),
    ...
    SELECT_TUPLE_ARITY(60, "select_tuple_arity", 3, arrayOf("tuple", "fail_label", "arity_label_list")),

    // @spec jump Label
    // @doc Jump to Label.
    JUMP(61, "jump", 1, arrayOf("label")),
    ...
    MOVE(64, "move", 2, arrayOf("source", "destination_register")),
    ...
    //       Head and Tail.
    GET_LIST(65, "get_list", 3, arrayOf("source", "head_register", "tail_register")),
    ...
    GET_TUPLE_ELEMENT(66, "get_tuple_element", 3, arrayOf("source", "element_number", "destination_register")),
    ...
    SET_TUPLE_ELEMENT(67, "set_tuple_element", 3, arrayOf("new_element", "tuple", "Position")),
    ...
    //      Save the next instruction as the return address in the CP register.
    CALL_FUN(75, "call_fun", 1, arrayOf("arity")),
    ...
    IS_FUNCTION(77, "is_function", 2, arrayOf("label", "argument")),
    ...
    //      Do not update the CP register.
    CALL_EXT_ONLY(78, "call_ext_only", 2, arrayOf("arity", "label")),
    ...
    BS_PUT_BINARY(90, "bs_put_binary", 5),
    BS_PUT_FLOAT(91, "bs_put_float", 5),
    BS_PUT_STRING(92, "bs_put_string", 2),
    ...
    IS_FUNCTION2(115, "is_function2", 3, arrayOf("label", "argument", "arity")),
    ...
    GC_BIF1(124, "gc_bif1", 5, arrayOf("label", "live_x_register_count", "bif", "argument", "destination_register")),
    ...
    //      Do a garbage collection if necessary to allocate space on the heap
    //      for the result (saving Live number of X registers).
    GC_BIF2(125, "gc_bif2", 6, arrayOf("label", "live_x_register_count", "bif", "argument1", "argument2", "destination_register")),
    ...
    IS_BITSTR(129, "is_bitstr", 2, arrayOf("label", "argument")),
    ...
    TRIM(136, "trim", 2, arrayOf("words_of_stack", "remaining")),
    ...
    RECV_MARK(150, "recv_mark", 1, arrayOf("label")),
    ...
    RECV_SET(151, "recv_set", 1, arrayOf("label")),
    ...
    //      Do a garbage collection if necessary to allocate space on the heap
    //      for the result (saving Live number of X registers).
    GC_BIF3(152, "gc_bif3", 7, arrayOf("label", "live_x_register_count", "bif", "argument1", "argument2", "argument3", "destination_register")),
    ...
    PUT_MAP_ASSOC(154, "put_map_assoc", 5),
    PUT_MAP_EXACT(155, "put_map_exact", 5),
    IS_MAP(156, "is_map", 2),
    HAS_MAP_FIELDS(157, "has_map_fields", 3),
    GET_MAP_ELEMENTS(158, "get_map_elements", 3),
    ...
    IS_TAGGED_TUPLE(159, "is_tagged_tuple", 4, arrayOf("label", "register", "arity", "tag")),
    ...
    init {
        if (argumentNames != null) {
            val argumentNameCount = argumentNames.size
