...
class Clause(val definition: Definition, metadata: OtpErlangObject, arguments: OtpErlangObject, guards: OtpErlangObject, val block: OtpErlangObject) {
    val metadata: Keyword? = org.elixir_lang.beam.chunk.from(metadata)
    val arguments: OtpErlangList? = arguments as? OtpErlangList
    val guards: OtpErlangList? = guards as? OtpErlangList
