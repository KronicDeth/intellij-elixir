...
import org.elixir_lang.beam.chunk.debug_info.v1.erl_abstract_code.abstract_code_compiler_options.abstract_code.comprehension.qualifier.Zip
...
object Qualifier {
    fun toMacroStringDeclaredScope(term: OtpErlangObject, scope: Scope): MacroStringDeclaredScope =
            ...
            Zip.ifToMacroStringDeclaredScope(term, scope) ?:
