    ...
    public TreeElement[] getChildren() {
        ...
        if (keywordArguments != null) {
            ...
            for (QuotableKeywordPair quotableKeywordPair : quotableKeywordPairList) {
                ...
                NameArityInterval nameArityInterval = new NameArity(name, arity).toNameArityInterval();

                boolean overridable = true;
                //noinspection ConstantConditions
                treeElementList.add(
                        new CallReference(modular, quotableKeywordPair, Time.RUN, overridable, nameArityInterval)
                );
            }
