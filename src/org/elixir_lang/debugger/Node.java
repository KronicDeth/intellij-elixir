...
public class Node {
    ...
    private final Queue<XDebuggerEvaluator.XEvaluationCallback> callbackQueue = new LinkedList<>();
    @NotNull
    ...
    private void addCallback(@NotNull XDebuggerEvaluator.XEvaluationCallback callback) {
    ...
    public void evaluated(@NotNull OtpErlangObject result) {
        synchronized (callbackQueue) {
            callbackQueue.remove().evaluated(Factory.create(result));
        }
    }
}
