...
class ElixirLineBreakpointHandler extends XBreakpointHandler<XLineBreakpoint<ElixirLineBreakpointProperties>> {
  ...
  @Override
  public void registerBreakpoint(@NotNull XLineBreakpoint<ElixirLineBreakpointProperties> breakpoint) {
    myDebugProcess.addBreakpoint(breakpoint);
  }

  @Override
  public void unregisterBreakpoint(@NotNull XLineBreakpoint<ElixirLineBreakpointProperties> breakpoint, boolean temporary) {
