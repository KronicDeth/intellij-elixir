...
class ElixirLineBreakpointType private constructor() : XLineBreakpointType<ElixirLineBreakpointProperties>(ID, NAME) {
    override fun canPutAt(file: VirtualFile, line: Int, project: Project): Boolean =
            file.fileType === ElixirFileType.INSTANCE && isLineBreakpointAvailable(file, line, project)

    override fun createBreakpointProperties(file: VirtualFile, line: Int): ElixirLineBreakpointProperties =
            ElixirLineBreakpointProperties()
