package org.elixir_lang.navigation.item_presentation.implementation;
...
public class ForName implements ItemPresentation, Parent {
    /*
     * Fields
     */
    ...
    public ForName(@NotNull String protocolName, @NotNull String forName) {
