 ...
 *
 * <p>Group of linked params. Sometime it's much more convenient to split cmdline in logical groups.
 * In this case it will be easier to patch such grouped argements using custom extentions
 *
 * <p>E.g.: we want to add Coverage support to all existing Ruby run configurations(ruby applications,
...
public class ParamsGroup implements Cloneable {
    private static final Logger logger = Logger.getInstance(ParamsGroup.class);
